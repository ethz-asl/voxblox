#ifndef VOXBLOX_FAST_SIMULATION_SIMULATION_WORLD_INL_H_
#define VOXBLOX_FAST_SIMULATION_SIMULATION_WORLD_INL_H_
...
#endif  // VOXBLOX_FAST_SIMULATION_SIMULATION_WORLD_INL_H_
