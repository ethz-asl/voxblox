#ifndef VOXBLOX_INTEGRATOR_ESDF_INTEGRATOR_NEW_H_
#define VOXBLOX_INTEGRATOR_ESDF_INTEGRATOR_NEW_H_
...
class EsdfIntegratorNew {
 public:
  ...
  EsdfIntegratorNew(const Config& config, Layer<TsdfVoxel>* tsdf_layer,
...
#endif  // VOXBLOX_INTEGRATOR_ESDF_INTEGRATOR_NEW_H_
