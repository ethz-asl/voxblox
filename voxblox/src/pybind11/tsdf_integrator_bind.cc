...
void tsdf_integrator_bind(py::module &m) {
  ...
  //
  //     // TODO(mereweth@jpl.nasa.gov) - how to overload this per derived
  //     class? .def("clearSphereAroundPoint",
  //     &TsdfIntegratorBase::clearSphereAroundPoint)
  //     .def("fillSphereAroundPoint",
  //     &TsdfIntegratorBase::fillSphereAroundPoint);
  ...
  py::class_<SimpleTsdfIntegrator>(m, "SimpleTsdfIntegrator")
      ...
      .def("clearSphereAroundPoint",
           &SimpleTsdfIntegrator::clearSphereAroundPoint)
      .def("fillSphereAroundPoint",
           &SimpleTsdfIntegrator::fillSphereAroundPoint);
}
