...
// reference counting
// auto loadTsdfLayer = (TsdfLayer (*)(const std::string &))
// &voxblox::io::LoadLayer<TsdfVoxel>;  auto loadEsdfLayer = (EsdfLayer (*)(const
// std::string &)) &voxblox::io::LoadLayer<EsdfVoxel>;

void layer_io_bind(py::module &m) {
  // NOTE (mereweth@jpl.nasa.gov) - provide function signature for overloaded
  // method
