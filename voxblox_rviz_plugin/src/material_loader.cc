...
void MaterialLoader::loadMaterials() {
  ...
  Ogre::ResourceGroupManager::getSingletonPtr()->initialiseResourceGroup("VoxbloxMaterials");
  Ogre::ResourceGroupManager::getSingletonPtr()->loadResourceGroup("VoxbloxMaterials");
